            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Total Harga Item</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group quantity mt-4" style="width: 100px;">
                                ...
                                <input id="qty-{{ $item['id'] }}" type="text" class="form-control form-control-sm text-center border-0 bg-transparent" value="{{ $item['quantity'] }}" readonly>
                                <div class="input-group-btn">
