...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            ...
            <p class="text-subtitle text-muted">Silahkan isi data category yang ingin diedit</p>
        </div>
    </div>
</div>
<div class="card">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Masukkan Nama Category" name="cat_name" value='{{$category->cat_name}}' required>
                        </div>
